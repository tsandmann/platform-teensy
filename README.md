...
### Notice
This is a customized version of the [teensy platform config](https://github.com/platformio/platform-teensy) for PlatformIO that uses a more recent cross-compiler toolchain (gcc 15.x) supporting [Linux x86_64](https://github.com/tsandmann/arm-cortexm-toolchain-linux), [macOS arm64](https://github.com/tsandmann/arm-cortexm-toolchain-macos-arm64), [macOS x86_64](https://github.com/tsandmann/arm-cortexm-toolchain-mac) and [Windows x86_64](https://github.com/tsandmann/arm-cortexm-toolchain-win64) hosts.
